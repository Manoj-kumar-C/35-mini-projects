...
const Page5 = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await fetch('https://crack-it-backend.vercel.app/cartoon'); // Replace with your actual API endpoint
  ...
  const renderItem = ({ item }) => (
    ...
    >
      <View style={styles.buttonContent}>
        ...
        <Image source={require('../../assets/memes/ButtonIcons/cartoon.png')} style={styles.customIcon} />
